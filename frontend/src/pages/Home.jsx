    ...
    <>
      <style>{`
        @keyframes heroFloat {
          ...
          50% { transform: translate3d(0, -12px, 0) rotate(1deg) scale(1.025); }
        }
                ...
                >
                  ...
                  <div
                    className="
                      ...
                      border-[var(--gold)]
                      bg-[var(--surface)]
                      shadow-[0_14px_28px_rgba(0,0,0,.35)]
                      transition-all
                      duration-500
                      group-hover:shadow-[0_26px_50px_rgba(0,0,0,.6)]
                    "
                  >
